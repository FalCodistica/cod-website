...
export function InstagramButton({ className = "" }: { className?: string }) {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      aria-label="Codistica on Instagram"
      className={`glass-pill inline-flex size-10 items-center justify-center transition-colors hover:bg-foam/15 ${className}`}
    >
      <svg width="18" height="18" viewBox="0 0 448 512" fill="#dde4e3" aria-hidden>
...
export function FacebookButton({ className = "" }: { className?: string }) {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      aria-label="Codistica on Facebook"
      className={`glass-pill inline-flex size-10 items-center justify-center transition-colors hover:bg-foam/15 ${className}`}
    >
      <svg width="12" height="19" viewBox="0 0 320 512" fill="#dde4e3" aria-hidden>
...
export function TikTokButton({ className = "" }: { className?: string }) {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      aria-label="Codistica on TikTok"
      className={`glass-pill inline-flex size-10 items-center justify-center transition-colors hover:bg-foam/15 ${className}`}
    >
      <svg width="16" height="18" viewBox="0 0 448 512" fill="#dde4e3" aria-hidden>
